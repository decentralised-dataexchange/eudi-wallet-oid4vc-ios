...
//    }
//    
//    //Modified the method to be compatible with Eliptic curve algorithm
//    func sign(_ digest: Data, privateKey: SecureEnclaveKeyReference) throws -> Data {
//        
//        
//        let algorithm: SecKeyAlgorithm = .ecdsaSignatureMessageX962SHA256
//            
//        guard SecKeyIsAlgorithmSupported(privateKey.underlying, .sign, algorithm) else {
//                throw SecureEnclaveHelperError(message: "Algorithm not supported", osStatus: .none)
//            }
//            
//            var error: Unmanaged<CFError>?
//        guard let signature = SecKeyCreateSignature(privateKey.underlying, algorithm, digest as CFData, &error) else {
//                print("Signing failed with error: \(error!.takeRetainedValue() as Error)")
//                throw SecureEnclaveHelperError(message: "Signing failed with error: \(error!.takeRetainedValue() as Error)", osStatus: .none)
//            }
//            
...
extension SecureEnclave {
    ...
    /// See https://developer.apple.com/documentation/security/certificate_key_and_trust_services/keys/storing_keys_in_the_secure_enclave
    static func generateKeyPair(with applicationTag: String) throws -> KeyPair {
        ...
        let publicKey_JWK: SecKey = try! jwk.converted(to: SecKey.self)
