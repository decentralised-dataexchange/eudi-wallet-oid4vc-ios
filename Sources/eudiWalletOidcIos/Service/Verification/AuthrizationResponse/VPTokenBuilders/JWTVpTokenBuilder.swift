...
class JWTVpTokenBuilder : VpTokenBuilder{
    ...
    func build(credentials: [String],
               ...
               did: String,
               index: Int?,
               keyHandler: SecureKeyProtocol, isSca: Bool = false, keyIds: [String] = [], amrInherenceFactor: String? = nil, amrKnowledgeFactor: String? = nil) async -> [String]? {
    ...
    func build2(credentials: [String], presentationRequest: PresentationRequest?, did: String, index: Int?, keyHandler: SecureKeyProtocol) async -> String? {
